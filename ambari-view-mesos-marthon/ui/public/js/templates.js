...
(function() {
    ...
    module.run(["$templateCache", function($templateCache) {
        $templateCache.put('app/components/frameworks/framework-executors/framework-executors.tpl.html', '<md-whiteframe class=\"md-whiteframe-6dp\">\r\n  <div class=\"toolbar-card\" flex>\r\n    <h4 class=\"md-subhead\"> Framework Executors </h4>\r\n  </div>\r\n  <md-content class=\"white-card\" layout-padding>\r\n    <div layout-padding>\r\n      <span class=\"breadcrumb-link\" ng-click=\"goToFrameworksTable()\"> Frameworks </span>\r\n      <span class=\"breadcrumb-arrow\"> > </span>\r\n      <span class=\"breadcrumb-current\"> {{frameworkId}} </span>\r\n    </div>\r\n\r\n    <div class=\"table\" layout=\"column\">\r\n      <table>\r\n        <tr>\r\n          <th> ID </th>\r\n          <th> Name </th>\r\n          <th> Sandbox </th>\r\n        </tr>\r\n        <tr ng-repeat=\"executor in frameworksExecutors\" ng-click=\"goToExecutorTasks(executor.slave_id, executor.executor_id)\">\r\n          <td class=\"border-left\"> {{executor.executor_id}} </td>\r\n          <td> {{executor.name}} </td>\r\n          <td class=\"border-right\">\r\n            <md-button class=\"md-raised\" ng-click=\"getSandbox(executor.slave_id, executor.framework_id, executor.id)\">\r\n              Sandbox\r\n            </md-button>\r\n          </td>\r\n        </tr>\r\n      </table>\r\n    </div>\r\n  </md-content>\r\n</md-whiteframe>\r\n');
    }]);
})();
(function() {
    var module;
    ...
    module.run(["$templateCache", function($templateCache) {
        $templateCache.put('app/components/frameworks/frameworks-table/frameworks-table.tpl.html', '<md-whiteframe id=\"frameworks-table-active\" class=\"md-whiteframe-6dp\">\r\n  <div class=\"toolbar-card\" flex>\r\n    <h4 class=\"md-subhead\"> Active Frameworks </h4>\r\n  </div>\r\n  <md-content class=\"white-card\" layout-padding>\r\n    <div class=\"table\" layout=\"column\">\r\n      <table>\r\n        <tr>\r\n          <th> ID </th>\r\n          <th> Name </th>\r\n          <th> Hostname </th>\r\n          <th> User </th>\r\n          <th> Active Tasks </th>\r\n          <th> CPUs </th>\r\n          <th> Memory </th>\r\n        </tr>\r\n        <tr ng-repeat=\"framework in frameworksActive\" ng-click=\"goToFrameworkExecutors(framework.id)\">\r\n          <td class=\"border-left\"> {{framework.id}} </td>\r\n          <td> {{framework.name}} </td>\r\n          <td> {{framework.hostname}} </td>\r\n          <td> {{framework.user}} </td>\r\n          <td> {{framework.tasks.length}} </td>\r\n          <td> {{framework.resources.cpus | toFixed}} </td>\r\n          <td class=\"border-right\"> {{framework.resources.mem | toGb}} Gb </td>\r\n        </tr>\r\n      </table>\r\n    </div>\r\n  </md-content>\r\n</md-whiteframe>\r\n\r\n<md-whiteframe id=\"frameworks-table-completed\" class=\"md-whiteframe-6dp\">\r\n  <div class=\"toolbar-card\" flex>\r\n    <h4 class=\"md-subhead\"> Completed Frameworks </h4>\r\n  </div>\r\n  <md-content class=\"white-card\" layout-padding>\r\n    <div class=\"table\" layout=\"column\">\r\n      <table>\r\n        <tr>\r\n          <th> Name </th>\r\n          <th> Hostname </th>\r\n        </tr>\r\n        <tr ng-repeat=\"framework in frameworksCompleted\">\r\n          <td class=\"border-left\"> {{framework.name}} </td>\r\n          <td class=\"border-right\"> {{framework.hostname}} </td>\r\n        </tr>\r\n      </table>\r\n    </div>\r\n  </md-content>\r\n</md-whiteframe>\r\n');
    }]);
})();
(function() {
    var module;
