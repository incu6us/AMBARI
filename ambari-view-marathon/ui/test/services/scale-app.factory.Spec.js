describe('ScaleAppFactory', function() {
  var ScaleAppFactory, httpBackend;

  beforeEach(module('MarathonApp'));

  beforeEach(inject(function($injector) {
    httpBackend = $injector.get('$httpBackend');
    ScaleAppFactory = $injector.get('ScaleAppFactory');
    spyOn(console, 'log');
  }));
  ...
  it('on put() changes configs of the app', function() {
    ...
    ScaleAppFactory.put(hostName, appID, data)
      .then(function() {
  ...
  it('on verison() get versions of the app', function() {
    ...
    ScaleAppFactory.version(hostName, appID)
  ...
  it('on get() get the configuration of the app', function() {
    ...
    ScaleAppFactory.get(hostName, appID, appVersion)
      .then(function(response) {
        expect(response).toEqual({'props':[]});
      });
