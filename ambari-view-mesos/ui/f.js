(function() {
  ...
  function MetricsCtrl(networkVisConfig, $scope, $timeout, $mdDialog, $uibModal, VisDataSet, ClusterNameFactory, MesosMasterFactory, MesosSlaveFactory, MetricsForMasterFactory, MetricsForSlaveFactory, ActiveMasterStateFactory, FrameworksFactory, $http, $mdSidenav) {
    var VERSION = "0.1.0";
    var DEBUG = false;
    ...
    // Vis Main config
    $scope.options = networkVisConfig().options;

    // D3 Main config
    $scope.d3Config = networkVisConfig().d3Config;

    // Vis configs for chart
    $scope.optionsMasterCpu = networkVisConfig().pieChartOptionsMasterCpu;
    $scope.optionsMasterMem = networkVisConfig().pieChartOptionsMasterMem;
    $scope.optionsMasterDisk = networkVisConfig().pieChartOptionsMasterDisk;
    $scope.optionsSlaveCpu = networkVisConfig().pieChartOptionsSlaveCpu;
    $scope.optionsSlaveMem = networkVisConfig().pieChartOptionsSlaveCpu;
    $scope.optionsSlaveDisk = networkVisConfig().pieChartOptionsSlaveCpu;
    ...
    function getMetricsForMaster(clusterName, masterHost) {
      ...
      $http.get('http://nikke1.github.io/hard-data/1snapshot.json', {
          cache: true
        })
